...
<div class="sticky top-0 z-50 flex justify-center mx-auto">
    <div class="bg-slate-600 w-full bg-base-100 mb-5 shadow-xl">
        <a class="btn btn-ghost normal-case text-xl" href="#TruthTable">Truth Table</a>
        <a class="btn btn-ghost normal-case text-xl" href="#KV">KV Diagramm</a>
        <a class="btn btn-ghost normal-case text-xl" href="#LatexTable">LatexTable</a>
        <a class="btn btn-ghost normal-case text-xl" href="#LatexAlgebra">LatexAlgebra</a>
    </div>
</div>
...
<main class="w-full h-full overflow-auto justify-center mx-auto text-white">
        ...
        <Accordion title="Truth Table">
            <div id="TruthTable" class="mx-auto md:m-0 md:flex">
                <div class="mx-auto md:m-0">
                    ...
                    <button class="btn btn-primary ml-5 mx-auto" on:click={()=>clearTable()}>Clear Table</button>
                </div>
                <div class="mx-auto md:m-0">
                    <TruthTable id="Table" {input_names} {output_names} editable={true} bind:values />
                </div>
            </div>
        </Accordion>
    </div>
    <div class="mx-5 m-2" id="Algbera">
        <Accordion title="Algebra">
            <Algebra {values} {input_names} {output_names} bind:CCNFS bind:CDNFS  bind:LaTexCCNFS bind:LaTexCDNFS/>
                </Accordion>
                </div>
                <div class="mx-5 m-2" id="KV-Diagramm">
